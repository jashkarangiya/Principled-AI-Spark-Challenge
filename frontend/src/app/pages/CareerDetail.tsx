...
import imgExperiencesHero from "figma:asset/cfc8f873b14b01fec8391ecc6f3d56b991ce4011.png";
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="bg-white flex flex-col lg:flex-row">
            ...
            <div className="flex-1 px-[47px] py-[32px]">
              <h2 className="font-['Arial:Bold',sans-serif] text-[32px] text-[#191919] leading-[28.8px] tracking-[-0.6px] mb-[36px]">
      ...
      <section className="bg-[#191919] py-[96px]">
        <div className="px-[60px]">
          <div className="max-w-[1200px] mx-auto">
            ...
            {/* Automation Risk */}
            <p className="font-['Arial:Regular',sans-serif] text-[18px] text-[#e8e8e8] leading-[25.2px] mb-[16px]">
              Automation Risk: <span className="font-['Arial:Bold',sans-serif] text-[#ffc627]">{career.automation_risk_pct}%</span>
            </p>

            {/* Automation Explanation */}
            <p className="font-['Arial:Regular',sans-serif] text-[16px] text-[#e8e8e8] leading-[24px] mb-[48px] max-w-[1024px]">
              {career.automation_explanation}
            </p>
            ...
            <div>
              ...
              <div className="flex flex-col gap-[24px]">
                {career.ethical_dilemmas.map((dilemma, index) => (
