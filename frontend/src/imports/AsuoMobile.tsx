import svgPaths from "./svg-p3jz72xmaq";
...
function Frame45() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[34px] items-center left-0 top-0 w-[390px]">
      <SectionProgramIntro />
      <SectionProgramRfi />
      <Frame46 />
      <DivRow5 />
...
function MainContent() {
  return (
    <div className="h-[13224.19px] relative shrink-0 w-full" data-name="main#content">
      <Frame45 />
    </div>
  );
}
