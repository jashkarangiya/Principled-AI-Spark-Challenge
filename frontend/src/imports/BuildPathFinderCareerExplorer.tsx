import svgPaths from "./svg-p8esbjhce5";
...
function Button() {
  return (
    <div className="absolute h-[21px] left-0 top-[14.3px] w-[54.487px]" data-name="Button">
...
function TextInput() {
  return (
    <div className="absolute bg-white h-[49px] left-[70px] top-[0.2px] w-[1192px]" data-name="Text Input">
...
function Container74() {
  return (
    <div className="absolute h-[49.6px] left-0 top-0 w-[1206px]" data-name="Container">
      <Button />
      <TextInput />
    </div>
  );
...
function Container76() {
  return <div className="absolute bg-[#8c1d40] h-[40px] left-[8px] rounded-[26843500px] top-[4px] w-[48px]" data-name="Container" />;
}
...
function Button1() {
  return (
    <div className="absolute content-stretch flex h-[40px] items-center justify-center left-[4px] rounded-[26843500px] top-[4px] w-[48px]" data-name="Button">
      <Icon6 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute content-stretch flex h-[40px] items-center justify-center left-[56px] rounded-[26843500px] top-[4px] w-[48px]" data-name="Button">
      <Icon7 />
    </div>
  );
}
...
function Container75() {
  return (
    <div className="absolute bg-white border-[#d0d0d0] border-[0.8px] border-solid h-[49.6px] left-[1152px] rounded-[26843500px] top-[61.2px] w-[109.6px]" data-name="Container">
      <Container76 />
      <Button1 />
      <Button2 />
    </div>
...
function Paragraph15() {
  return (
    <div className="absolute h-[21px] left-0 top-[65.6px] w-[1206px]" data-name="Paragraph">
...
function Container77() {
  return (
    <div className="absolute h-[1220.6px] left-0 top-[118.6px] w-[1282px]" data-name="Container">
      <Link12 />
      <Link13 />
      <Link14 />
      <Link15 />
...
function Container73() {
  return (
    <div className="flex-[1_0_0] h-[1339.2px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container74 />
        <Container75 />
        <Paragraph15 />
...
function Container72() {
  return (
    <div className="absolute content-stretch flex gap-[50px] h-[1339.2px] items-start left-[60px] top-[395.2px] w-[1572px]" data-name="Container">
      <Sidebar />
      <Container73 />
    </div>
  );
...
function MainContent() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[1782.4px] left-0 top-[147.6px] w-[1692px]" data-name="Main Content">
      <Container71 />
      <Container72 />
    </div>
  );
...
function Footer() {
  return (
    <div className="absolute content-stretch flex flex-col h-[368px] items-start left-0 top-[1930px] w-[1692px]" data-name="Footer">
      <Container498 />
      <Container503 />
      <Navigation1 />
    </div>
