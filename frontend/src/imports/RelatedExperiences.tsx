import svgPaths from "./svg-2f58vant4f";
...
export default function RelatedExperiences() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[128px] py-[64px] relative size-full" data-name="related experiences">
      <DivContainerLg />
    </div>
  );
}