import svgPaths from "./svg-ku9oct1fiq";
import imgImage from "figma:asset/5c3df7bc056cf0a7a2c145a06887a3a068f28c54.png";

function Image() {
  return (
    <div className="h-[180px] relative shrink-0 w-full" data-name="Image">
...
function PFsXs() {
  return (
    <div className="absolute bg-[#191919] content-stretch flex flex-col items-start left-[26px] p-[4px] top-[168px]" data-name="p.fs-xs">
